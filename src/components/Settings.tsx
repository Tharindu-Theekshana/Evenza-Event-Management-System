          ...
          <div className="mt-10 text-center">
            <div className="bg-white/60 backdrop-blur-sm rounded-xl shadow-sm p-6 border border-blue-100/50">
              ...
              <button
                ...
                className="inline-flex items-center px-6 py-2 bg-blue-900 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                Contact Support
              </button>
            </div>
          </div>
